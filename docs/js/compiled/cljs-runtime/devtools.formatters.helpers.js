...
var G__42701 = devtools.prefs.pref(v);
v = G__42701;
continue;
} else {
return v;
...
}catch (e42654){var _e__42144__auto__ = e42654;
return false;
}})();
...
}catch (e42658){var _e__42144__auto__ = e42658;
return false;
}})();
...
}catch (e42663){var _e__42144__auto__ = e42663;
return false;
}}
}
});
...
var vec__42682 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42682,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42682,(1),null);
...
return cljs.core.some((function (p1__42689_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42689_SHARP_);
}),template);
});
