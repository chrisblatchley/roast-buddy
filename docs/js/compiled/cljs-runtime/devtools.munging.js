...
var o42446 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42446["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42447 = temp__5733__auto____$1;
return (o42447["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42134__auto__ = f;
return (o__42134__auto__["toString"]).call(o__42134__auto__);
} else {
return "";
}
}catch (e42452){var _ = e42452;
return "";
}});
...
try{var o__42134__auto___42643 = t;
(o__42134__auto___42643["cljs$lang$ctorPrWriter"]).call(o__42134__auto___42643,t,writer);
}catch (e42457){var __42644 = e42457;
}
...
var char_code = (function (){var o__42134__auto__ = (new String(char$));
return (o__42134__auto__["charCodeAt"]).call(o__42134__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42134__auto__ = String;
return (o__42134__auto__["fromCharCode"]).call(o__42134__auto__,subscript_code);
});
/**
...
var o__42134__auto__ = String;
return (o__42134__auto__["fromCharCode"]).call(o__42134__auto__,superscript_code);
});
/**
...
}catch (e42475){var _e__42144__auto__ = e42475;
return false;
}})())){
...
var vec__42476 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42476,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42495){
var vec__42496 = p__42495;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42496,(0),null);
...
var G__42665 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42666 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42665;
remaining_tokens = G__42666;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42493){
var G__42494 = cljs.core.first(seq42493);
var seq42493__$1 = cljs.core.next(seq42493);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42494,seq42493__$1);
}));
...
var vec__42506 = cljs.core.split_with((function (p1__42505_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42505_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42506,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42506,(1),null);
...
var vec__42513 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42513,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42513,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42671 = cljs.core.rest(remaining_tokens);
var G__42672 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42671;
name_tokens = G__42672;
continue;
} else {
...
var vec__42521 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42521,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42521,(1),null);
var vec__42524 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42524,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42524,(1),null);
var vec__42527 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42527,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42527,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42527,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42527,(3),null);
...
var vec__42533 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42533,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42533,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42533,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42533,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42533,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42533,(5),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42552 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42552) : devtools.munging.parse_fn_info_deep.call(null,G__42552));
})()));
}
} else {
return fn_info;
...
var G__42698 = (arity + (1));
var G__42699 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42562){
var vec__42563 = p__42562;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42563,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42563,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42568_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42568_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42569_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42569_SHARP_);
}),sorted_infos);
...
var G__42715 = (i__4790__auto___42713 + (1));
i__4790__auto___42713 = G__42715;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42583){
var vec__42584 = p__42583;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42584,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42576){
var G__42577 = cljs.core.first(seq42576);
var seq42576__$1 = cljs.core.next(seq42576);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42577,seq42576__$1);
}));
...
var G__42588 = arg;
var G__42588__$1 = (((G__42588 instanceof cljs.core.Keyword))?G__42588.fqn:null);
switch (G__42588__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42592__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42592__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42592__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42592__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42593 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42593,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42593,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42593,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42593,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42593,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42593,(5),null);
...
var o__42134__auto__ = f;
return (o__42134__auto__["getBasis"]).call(o__42134__auto__);
});
/**
...
}catch (e42604){var _e__42144__auto__ = e42604;
...
var G__42732 = (obj[cljs.core.first(path)]);
var G__42733 = cljs.core.rest(path);
obj = G__42732;
path = G__42733;
continue;
} else {
...
var _STAR_ = (function (accum,p__42612){
var vec__42613 = p__42612;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42613,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42613,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42617){
var vec__42618 = p__42617;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42618,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42618,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42618,(2),null);
...
var post_process = (function (p__42625){
var vec__42627 = p__42625;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42627,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42627,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42624_SHARP_){
return (obj[cljs.core.first(p1__42624_SHARP_)]);
}),sorted_matches);
