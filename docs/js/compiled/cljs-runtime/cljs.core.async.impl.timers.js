...
var i_45988 = (self__.level + (1));
while(true){
if((i_45988 <= (new_level + (1)))){
(update[i_45988] = self__.header);

var G__45993 = (i_45988 + (1));
i_45988 = G__45993;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_45994 = (update[i]).forward;
(x__$2.forward[i] = (links_45994[i]));
...
var i_46001 = (0);
while(true){
if((i_46001 <= self__.level)){
var links_46002 = (update[i_46001]).forward;
if((x__$1 === (((i_46001 < links_46002.length))?(links_46002[i_46001]):null))){
(links_46002[i_46001] = (x__$1.forward[i_46001]));

var G__46005 = (i_46001 + (1));
i_46001 = G__46005;
continue;
} else {
var G__46006 = (i_46001 + (1));
i_46001 = G__46006;
continue;
}
} else {
...
var G__46009 = nx;
var G__46010 = (level__$1 - (1));
x = G__46009;
level__$1 = G__46010;
continue;
} else {
var G__46011 = x;
var G__46012 = (level__$1 - (1));
x = G__46011;
level__$1 = G__46012;
continue;
}
