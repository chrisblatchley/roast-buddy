...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42708){
var G__42709 = cljs.core.first(seq42708);
var seq42708__$1 = cljs.core.next(seq42708);
var G__42710 = cljs.core.first(seq42708__$1);
var seq42708__$2 = cljs.core.next(seq42708__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42709,G__42710,seq42708__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42728_SHARP_){
return (!((cljs.core.meta(p1__42728_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42746__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42753){var _e__42144__auto__ = e42753;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e42755){var _e__42144__auto__ = e42755;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42757 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42758 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42758);

try{var map__42759 = opts;
var map__42759__$1 = (((((!((map__42759 == null))))?(((((map__42759.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42759.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42759):map__42759);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42759__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42757);
}});
...
var temp__5733__auto___42791 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42791)){
var managed_print_level_42792 = temp__5733__auto___42791;
var _STAR_print_level_STAR__orig_val__42765_42793 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42766_42794 = managed_print_level_42792;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42766_42794);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42761_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42761_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42765_42793);
}} else {
job_fn();
}
