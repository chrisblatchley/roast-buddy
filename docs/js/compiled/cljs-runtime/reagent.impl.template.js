...
var G__51543 = o;
goog.object.set(G__51543,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51676__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51676 = function (var_args){
var args = null;
...
while (G__51681__i < G__51681__a.length) {G__51681__a[G__51681__i] = arguments[G__51681__i + 0]; ++G__51681__i;}
  args = new cljs.core.IndexedSeq(G__51681__a,0,null);
} 
return G__51676__delegate.call(this,args);};
G__51676.cljs$lang$maxFixedArity = 0;
G__51676.cljs$lang$applyTo = (function (arglist__51682){
var args = cljs.core.seq(arglist__51682);
return G__51676__delegate(args);
});
G__51676.cljs$core$IFn$_invoke$arity$variadic = G__51676__delegate;
return G__51676;
})()
;
} else {
...
var G__51549 = o;
goog.object.set(G__51549,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51709__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51709 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__51714__i < G__51714__a.length) {G__51714__a[G__51714__i] = arguments[G__51714__i + 0]; ++G__51714__i;}
  args = new cljs.core.IndexedSeq(G__51714__a,0,null);
} 
return G__51709__delegate.call(this,args);};
G__51709.cljs$lang$maxFixedArity = 0;
G__51709.cljs$lang$applyTo = (function (arglist__51717){
var args = cljs.core.seq(arglist__51717);
return G__51709__delegate(args);
});
...
var G__51551 = props;
var G__51551__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51551,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51551);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51551__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__51551__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51553 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51553,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51553;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51559){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51560__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__51575_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51575_SHARP_);
}));
} else {
return null;
}
...
var vec__51582 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51582,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51582,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51582,(2),null);
...
var temp__5739__auto___51779 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___51779 == null)){
} else {
var key_51780 = temp__5739__auto___51779;
(jsprops.key = key_51780);
}
...
var temp__5739__auto___51781 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___51781 == null)){
} else {
var key_51782 = temp__5739__auto___51781;
(jsprops.key = key_51782);
}
...
var G__51587 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__51587) : reagent.impl.template.as_element.call(null,G__51587));
} else {
var temp__5739__auto___51806 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___51806 == null)){
} else {
var key_51807 = temp__5739__auto___51806;
(jsprops.key = key_51807);
}
...
var G__51592 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__51592)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__51592)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51593){
var G__51594 = cljs.core.first(seq51593);
var seq51593__$1 = cljs.core.next(seq51593);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51594,seq51593__$1);
}));
...
break;
default:
var G__51828 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__51828;
continue;
...
var ctx = ({});
var vec__51626 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51626,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51626,(1),null);
...
var G__51660 = (cljs.core.count(argv) - first_child);
switch (G__51660) {
case (0):
